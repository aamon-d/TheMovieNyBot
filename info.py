...
support_chat_id = environ.get('@DARKWOLF6d')
reqst_channel = environ.get('-1002195145166')
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+kpa_bFnZAIoxYzI1')
